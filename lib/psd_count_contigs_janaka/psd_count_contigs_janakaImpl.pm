package psd_count_contigs_janaka::psd_count_contigs_janakaImpl;
use strict;
...
sub new
{
    ...
    my $wsInstance = $cfg->val('psd_count_contigs_janaka','workspace-url');
...
sub count_contigs
{
    ...
    my $ctx = $psd_count_contigs_janaka::psd_count_contigs_janakaServer::CallContext;
    my($return);
    #BEGIN count_contigs
