SERVICE = psd_count_contigs_janaka
SERVICE_CAPS = psd_count_contigs_janaka
SPEC_FILE = psd_count_contigs_janaka.spec
URL = https://kbase.us/services/psd_count_contigs_janaka
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
